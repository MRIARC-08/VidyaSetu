      ...
      <div id="features" className="flex flex-col min-h-screen p-4 pl-8 pr-8 gap-16">
        ...
        <div className="flex justify-between gap-12 flex-wrap">
          ...
          <div className="flex-1 p-12 flex gap-4 relative flex-col justify-center">
            <Image src={DV} alt="data" className="absolute inset-0 h-full w-full"></Image>
