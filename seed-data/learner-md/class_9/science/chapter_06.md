...
In Chapter 4, you learnt how to describe motion using position, velocity, acceleration, equations, and graphs.
...
Force is like displacement, velocity, and acceleration: direction matters.
...
A **spring balance** can measure the magnitude of force.

It is commonly used to measure **weight**, which is the gravitational force with which Earth pulls an object.

> [!NOTE]
> The **weight** of an object is the gravitational force acting on it.

When you pull the free end of a spring balance, it measures the force with which you pull the spring inside it.
...
> [!NOTE]
> **Balanced forces** are forces that cancel each other so that the net force is zero.
...
> [!NOTE]
> **Unbalanced forces** produce a non-zero net force and can change an object's motion.

If one team pulls harder, the rope moves in the direction of the larger force.
...
### 📐 Example 6.1 — Net Force on a Block
...
Sometimes equal and opposite forces act at different points of an extended object and make it rotate. For example, turning a handlebar or tap involves rotation. You will study such cases in higher grades.

---

## 6.3 — The Force of Friction

When you push a box, it may not move immediately. You may need to push harder.

The reason is **friction**.

> [!NOTE]
> **Friction** is a force that opposes relative motion or attempted relative motion between surfaces in contact.
...
For a box resting on a horizontal floor, weight and normal force balance each other vertically.

### Why Moving Objects Stop

If a moving box loses contact with the pushing hand or rubber band, the applied force disappears. Friction may still act opposite to motion, so the object slows down and eventually stops.
...
### 🔬 Activity 6.1 — Friction on Different Surfaces

**Aim:** To compare how far a stack of coins travels on different surfaces.
...
### 🔬 Activity 6.2 — Measuring Friction with Spring Balance

**Aim:** To compare friction on different surfaces using a spring balance.
...
### Thought Experiment — What if Friction Were Zero?

If friction were zero and an object were set moving on a perfectly smooth horizontal surface, it would not slow down due to surface friction. It would continue moving with constant velocity unless another net force acted on it.

### Meet the Scientists — Galileo and Newton

**Galileo Galilei** argued through thought experiments that if all impediments to motion are removed, a body moving on a horizontal plane would continue moving indefinitely.

**Isaac Newton** used the idea of **inertia** to formulate the first law of motion and later stated three laws of motion in 1687. The SI unit of force is named after Newton.
...
> [!NOTE]
> **Newton's first law of motion:** An object at rest remains at rest, and an object in motion continues to move with constant velocity, unless a net force acts on the object.
...
### 📐 Example 6.2 — Box with Applied Force Equal to Friction
...
### 📐 Example 6.3 — Graphs When Net Force Is Zero

If no net force acts on an object, two situations are possible.
...
> [!TIP]
> A horizontal velocity-time graph means constant velocity. If velocity is zero, the object is at rest. If velocity is non-zero, the object moves uniformly.
...
> [!NOTE]
> **Newton's second law of motion:** When a net force acts on an object, the object accelerates in the direction of the net force. The magnitude of acceleration is directly proportional to net force and inversely proportional to mass.
...
> [!NOTE]
> The acceleration due to gravity `g` is nearly independent of mass near Earth's surface.
...
Newton's second law can also be stated as: the rate of change of momentum is proportional to the net force and takes place in the direction of the net force.

---

### 🔬 Activity 6.3 — Force and Acceleration

**Aim:** To test whether larger force produces larger acceleration for the same object.

The activity uses a cart pulled by a cup hanging over a pulley. Increasing the mass in the cup increases the pulling force.
...
For two trials over the same distance:
...
### 🔬 Activity 6.4 — Mass and Acceleration

**Aim:** To test whether larger mass gives smaller acceleration for the same force.
...
> [!TIP]
> Same force on smaller mass gives larger acceleration. Same force on larger mass gives smaller acceleration.
...
A coconut brought down at high speed stops in a very short time on a hard surface. The rapid change in velocity requires a large force, which breaks the shell.

---

### 📐 Example 6.4 — Force Applied by Weightlifter
...
To keep it steady, the weightlifter applies **294 N upward**.

---

### 📐 Example 6.5 — Block, Friction, and Displacement

A 25 kg block is on a horizontal floor. Maximum friction opposing motion is 50 N.
...
Starting from rest, displacement in 2 s:
...
So the block moves **0.4 m forward**.

---

### 📐 Example 6.6 — Force from a Velocity-Time Graph
...
The negative sign means the force is opposite to the chosen eastward direction.

---

## 6.6 — Newton's Third Law of Motion

For a force to exist, at least two objects must interact.

> [!NOTE]
> **Newton's third law of motion:** Whenever one object exerts a force on a second object, the second object simultaneously exerts an equal and opposite force on the first object.
...
### 🔬 Activity 6.6 — Two Spring Balances

Two identical spring balances are connected by hooks and pulled.
...
The climber pushes down on the tree trunk with legs. Friction from the trunk pushes the climber upward. Smooth trunks are harder to climb because friction is lower.
...
In the balloon activity, air rushes out in one direction and the balloon moves in the opposite direction.
...
If a spacecraft fires its engine in the direction of motion, exhaust gases exert a force opposite to motion, slowing the spacecraft. This principle was used by the Vikram lander to reduce speed for a soft landing.
...
### 📐 Example 6.7 — Earth and Fruit

The Earth pulls a fruit downward. The fruit pulls the Earth upward with an equal gravitational force.

Why does the fruit move visibly while Earth does not?
...
The force magnitude is equal on both, but Earth's mass is extremely large. Therefore, Earth's acceleration is too tiny to notice.

---

### 📐 Example 6.8 — Bullet and Gun

A bullet of mass 0.1 kg is fired from a gun of mass 5 kg. The force magnitude is 2 N.

By Newton's third law, bullet and gun experience equal force magnitudes, but in opposite directions.
...
> [!NOTE]
> Equal forces do not necessarily produce equal accelerations because acceleration also depends on mass.

---

## 6.7 — Forces Acting on a System of Objects

Newton's laws can be applied to a single object or a system of connected objects.

Suppose two boxes of masses `m_1` and `m_2` are connected by a string on a frictionless horizontal surface. A force `F` pulls them to the right.
...
> [!TIP]
> Treating connected objects as one system often makes force problems simpler.
...
Scientists continue to reduce friction using lubricants, coatings, surface textures, streamlined shapes, and magnetic levitation. But friction is not simply an enemy; without it, walking, gripping, braking, writing, and many machines would not work normally.
