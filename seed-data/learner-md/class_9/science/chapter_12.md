...
Earth contains an enormous variety of life: bacteria, algae, fungi, plants, animals, and many microscopic organisms.

This variety is called **biodiversity**.

Classification helps us organize this diversity so we can:

- identify organisms;
- compare similarities and differences;
- understand evolutionary relationships;
- study ecological roles;
- communicate using common scientific names;
- conserve threatened species and habitats.
...
## 12.0 - Introduction: Biodiversity and Classification

Life exists in countless forms and habitats:

- microscopic organisms invisible to the naked eye;
- fungi and bacteria in soil;
- algae in oceans;
- trees in forests;
- insects in crop fields;
- fish in rivers;
- birds in the sky;
- animals in deserts, mountains, forests, oceans, and grasslands.

This immense variety of living organisms is called **biodiversity**.
...
- livelihoods;
- farming stability;
- ecosystem services such as pollination and soil fertility.

### Why Farmers Value Diversity

Farmers have long conserved crop varieties with useful traits such as:

- drought tolerance;
- pest resistance;
- ability to grow in poor soils;
- adaptation to local climate;
- reliable yield under changing conditions.

Diversity reduces the risk of total crop failure.
...
These differences support many species.

---

## Endemic Species

An endemic species is naturally found only in a particular region.
...
1. has many endemic species; and
2. has experienced significant habitat loss.

Examples connected with India:
...
### Why Hotspots Need Protection

Hotspots are important because they:

- contain unique species;
- support food webs;
- maintain ecological balance;
- hold genetic resources;
...
Biodiversity did not appear all at once. It developed over long periods of time.

Small differences among individuals can affect:

- survival;
- reproduction;
- ability to find food;
- ability to avoid predators;
- ability to tolerate climate;
- ability to resist disease.

Over many generations, useful differences may accumulate. This can lead to new forms of life.
...
## Indian Ecological Traditions

Some Indian traditions recognized landscapes and living communities in practical ways.

Examples include:

- Sangam Tinai classification of landscapes;
- protection of sacred groves;
- local conservation customs;
- community knowledge of habitats and organisms.

These traditions helped preserve local biodiversity even when they were not written as formal modern ecological theories.
...
When looking at organisms, we may ask:

- Where does it live?
- Does it move?
- What does it eat?
- Is it active during day or night?
- Does it have wings, legs, fins, feathers, scales, or fur?
- Is it microscopic or visible?
- Is it unicellular or multicellular?

### Activity 12.1 - Compare and Classify

Learners observe organisms in a picture and group them using different criteria.
...
Classification depends on the feature chosen. Scientists choose features that reveal deeper similarities and relationships.
...
Organisms with similar DNA are likely to share common ancestry. This helps scientists understand evolutionary relationships more deeply than external appearance alone.

---

## 12.4 - Need for Classification

Imagine a library where thousands of books are scattered on the floor. Finding one book would be difficult.

Classification is like arranging books by:
...
Similarly, Earth has millions of organisms. Classification organizes them so they can be studied systematically.

---

## Activity 12.2 - Pakke Tiger Reserve Case Study

Pakke Tiger Reserve in Arunachal Pradesh has nearly 300 bird species. India as a whole has about 1,300 bird species.

Pakke also supports four hornbill species:
...
Hornbills may lose nesting sites. This can reduce hornbill populations and affect seed dispersal because hornbills help spread seeds of forest plants.
...
Classification systems changed as knowledge increased.
...
Classification changed because scientists developed:
...
Science changes when better evidence becomes available. A changing classification system does not mean science is weak; it shows science is self-correcting and evidence-based.

---

## 12.6 - Five Kingdom Classification

Whittaker's five kingdom classification groups life into:
...
Monera includes unicellular organisms without a membrane-bound nucleus.
...
Some bacteria are pathogens, meaning they cause disease.

### Cyanobacteria

Cyanobacteria are photosynthetic prokaryotes. They were among the earliest organisms to release oxygen through photosynthesis.

Their ancient activity helped oxygen accumulate in the atmosphere, making Earth suitable for many later forms of life.

### Indian Context: Biogas

Ram Bux Singh, known as the Father of Modern Biogas, contributed to scientifically designed biogas plants in India. Biogas technology connects microorganisms, waste management, renewable energy, and rural development.

---

## 12.6.2 - Kingdom Protista: Unicellular Eukaryotes

Protista includes single-celled eukaryotes.
...
Hay infusion may smell bad and may contain microbes. Use lab coat, mask, gloves, and proper disposal methods under teacher guidance.
...
- produce oxygen when photosynthetic;
- serve as food for small animals;
- help in nutrient cycling.

---

## 12.6.3 - Kingdom Fungi: Heterotrophs with Chitin Cell Walls
...
Many fungi have fine filaments. A network of these filaments is called **mycelium**.

Fungi absorb nutrients from dead or decaying matter, living hosts, or symbiotic partners.
...
- produce enzymes;
- serve as food in the form of edible mushrooms;
- support livelihoods through mushroom cultivation.

### Lichens

Lichens are mutual associations between:
...
## 12.6.4 - Kingdom Plantae: Multicellular Autotrophs

Plants are multicellular eukaryotes that perform photosynthesis.
...
## Thallophyta: Simple Plant Body

Thallophytes have an undifferentiated body called a thallus.
...
The simple body allows direct exchange of water, nutrients, and gases with the surroundings.

### Limitation

They cannot live successfully in dry land environments.
...
### Activity 12.6 - Observing Bryophytes

Learners observe bryophytes using a hand lens or dissecting microscope and compare them with common leaves.

Key observation:

> Bryophyte structures are simpler than true leaves, stems, and roots of higher plants.

---

## Pteridophyta: Vascular Tissue without Seeds
...
- transport food to different parts;
- grow larger than bryophytes;
- colonize land more effectively.

### Activity 12.7 - Fern Stem Comparison

Learners compare a fern stem cross-section with a sunflower stem cross-section.

Focus:

- arrangement of vascular tissue;
- presence of xylem and phloem;
- similarities and differences between pteridophytes and higher plants.
...
Needle-like leaves reduce water loss and help survival in harsh conditions.

Seeds protect the developing embryo and contain stored food.
...
- many pollination strategies;
- broad adaptation to different habitats.

---

## Activity 12.8 - Monocots and Dicots
...
Plant groups show increasing adaptation to life on land:

1. simple aquatic thallus;
2. moist-land bryophytes;
3. vascular pteridophytes;
4. seed-producing gymnosperms;
5. flowering and fruit-producing angiosperms.

---

## 12.6.5 - Kingdom Animalia: Multicellular Heterotrophs

Animals are multicellular eukaryotes that depend on other organisms for food.
...
## Cnidaria: True Tissues and Tentacles
...
A single opening limits efficiency because the same opening is used for ingestion and egestion.
...
Bilateral symmetry means the body can be divided into two similar halves along one plane.

This supports directional movement and better coordination.

### Health Link

Some parasitic worms enter through contaminated food or water. Prevention includes:
...
- more precise locomotion.

---

## Arthropoda: Jointed Appendages and Exoskeleton
...
Both have segmented bodies, but beetles have a hard external skeleton. This helps beetles survive by protecting them and reducing water loss.

---

## Mollusca: Soft Bodies
...
## Echinodermata: Spiny Skin and Internal Skeleton
...
## Protochordates: Appearance of Notochord

Protochordates such as Amphioxus possess a notochord at least once during life.
...
- allows movement;
- represents a key structural step toward vertebrates.

Protochordates help us understand how animals with notochords may have arisen from simpler forms.
...
- works with complex organ systems.
...
## Biodiversity and Disaster Protection

Rich biodiversity can reduce disaster impacts.
...
Animal diversity reflects many body forms shaped by different survival challenges.

---

## 12.7.1 - Hierarchical Nature of Classification
...
At each lower level, organisms share more features.
...
Genus has fewer members than class, but members of a genus share more features with one another.
...
Binomial nomenclature is a two-part naming system introduced by Carolus Linnaeus.

Each scientific name has:
...
Tiger and lion are placed in the same genus **Panthera** because they share important features such as roaring ability and skull similarities.

---

## Beyond Five Kingdoms: Three Domain System

As scientists studied DNA, they found deeper differences among organisms.
...
The three domain system showed that microscopic life is more diverse than earlier classification systems suggested.

It also shows that classification keeps changing as evidence improves.

---

## 12.9 - Fossils as Evidence

Fossils are preserved remains or traces of ancient plants and animals found in layers of rocks, sand, or mud.
...
### Indian Scientist: Birbal Sahni

Birbal Sahni studied fossil plants and founded the Birbal Sahni Institute of Palaeosciences in Lucknow.

His work helped connect present-day plants with ancient plant life and showed that life has a long, connected history.
...
Human activities reducing biodiversity include:
...
If one species disappears, species that depend on it may also decline.

Example:

- Loss of pollinators can reduce fruit and seed formation.
- Loss of old nesting trees can reduce hornbill populations.
- Loss of phumdis can threaten Sangai deer.
...
## Loktak Lake, Phumdis, and Sangai Deer

Phumdis are floating grasslands in Loktak Lake, Manipur.

They are unique habitats made of floating soil, organic matter, and rooted vegetation.

The endangered Sangai deer depends on this habitat.
...
- protect and restore phumdis;
- reduce pollution in Loktak Lake;
- regulate harmful development;
- involve local communities;
- monitor Sangai population;
- protect breeding areas;
- support scientific research and traditional knowledge.
...
An insect belongs to Arthropoda. The most useful confirming feature from the options is:

> Body with jointed legs.

### Exercise 2

Sponges are animals because they are multicellular heterotrophs and lack a cell wall.

If choosing from the given options, the closest relevant animal-cell feature is:

> Presence of a cell membrane.

But the stronger explanation is that sponge cells lack cell walls and do not photosynthesize.

### Exercise 4

Cellular organization is more fundamental because it applies across all life forms. It can separate prokaryotes from eukaryotes and unicellular from multicellular organisms.

Xylem and phloem are useful only for classifying certain plants, especially vascular plants. They cannot classify bacteria, fungi, protists, or animals.

### Exercise 5

A single-celled organism with a well-defined nucleus and cilia most likely belongs to **Protista**.

Reason:

- it is unicellular;
- it is eukaryotic;
- cilia are common in protists such as Paramecium.

### Exercise 6

Biodiversity stabilizes ecosystems because different organisms perform different roles:

- plants produce food;
- decomposers recycle nutrients;
- pollinators help plants reproduce;
- predators regulate prey populations;
- microorganisms support soil and water quality.

Greater diversity can make ecosystems more resilient to disturbance.

### Exercise 7

If all unicellular organisms were placed in one kingdom, bacteria and Amoeba would be grouped together even though bacteria are prokaryotic and Amoeba is eukaryotic.

This would hide major differences in:
...
- they are acellular;
- they lack normal cellular organization;
- they do not carry out independent metabolism;
- they reproduce only inside host cells;
- outside a host, they remain inactive.

### Exercise 9

A separate category for viruses can be justified because they contain genetic material and evolve, but they lack cellular organization.

Keeping them outside the five kingdoms is also justified because the five kingdom system classifies cellular life.

This shows that classification systems change when new evidence creates new questions.

### Exercise 10

Viruses have genetic material but lack cellular structure. They do not have cytoplasm, cell organelles, or independent metabolism.

These features prevent them from fitting into Monera, Protista, Fungi, Plantae, or Animalia.
...
Genus has fewer members than class, but members of a genus have more features in common.

Reason:

Classification becomes more specific as we move downward:
...
> It is multicellular, filamentous, has a cell wall, lacks chlorophyll, and grows on dead organic matter.
...
R and Q are both eukaryotic, but:

- R is unicellular and can photosynthesize in light;
- Q is multicellular, filamentous, lacks chlorophyll, and absorbs nutrients from dead matter.

So they belong to different kingdoms.

#### 15(iv)

S cannot be classified by nutrition alone because many animal groups are heterotrophic. More specific features such as backbone, tissues, body organization, and life stage are needed.

#### 15(v)

T does not fit any five kingdom group because it is acellular. The five kingdom system is mainly for cellular organisms.

#### 15(vi)

If classification used habitat only, organisms from very different groups could be wrongly grouped together.

Example:

- fish, aquatic plants, algae, bacteria, and protists all live in water but belong to different kingdoms.

Scientific consequence:

> Such grouping would hide real cellular, structural, nutritional, and evolutionary differences.

#### 15(vii)

A multicellular eukaryote that lacks chlorophyll and absorbs nutrients from a host externally should likely be placed under Fungi if it has fungal features such as chitin cell wall and absorptive nutrition.

It should not be placed in Animalia because animals usually ingest food and lack cell walls.
...
1. biodiversity;
2. why classification is needed;
...
1. Monera vs Protista;
2. Fungi vs Plantae;
3. plant groups;
4. invertebrate phyla;
5. chordates and vertebrates.

### Third Pass

Practice reasoning:

1. identify kingdom from clues;
2. explain why habitat alone is weak classification;
3. classify unknown organisms from features;
4. write scientific names correctly;
5. connect biodiversity loss with ecosystem effects.
...
- Why are viruses outside the five kingdom system?
- How does classification help conservation?

---

## One-Page Summary

Biodiversity is the variety of living organisms, their habitats, and their ecological roles. India has many biodiversity-rich regions because of its varied landscapes, climates, and habitats. Some species are endemic, meaning they occur naturally only in particular regions. Biodiversity hotspots are regions with many endemic species and serious habitat loss.

Classification is the scientific grouping of organisms. It helps organize biodiversity, identify organisms, compare similarities and differences, understand relationships, and support conservation. Scientists classify organisms using features such as cell type, number of cells, cell wall, nutrition, body organization, reproduction, ecological role, and genetic similarity.

Classification systems have changed over time. Early systems used habitat and external features. Later systems used cell structure, microscopic study, nutrition, and evolutionary relationships. Whittaker's five kingdom classification includes Monera, Protista, Fungi, Plantae, and Animalia.
