...
This chapter explores two kinds of communication.

The prose **Carrier of Words** shows how words physically travel through letters, money orders, and human effort. Khetaram carries mail across desert distances, but he also carries trust, news, comfort, and social connection.

The poem **Words** asks whether words alone can truly satisfy the heart. It warns that many words can be empty, while a few sincere words can bring deeper joy.

Together, the texts teach that communication is not only about sending messages. It is about sincerity, responsibility, empathy, and human trust.

---

# Unit 7A: Before Reading

## Profession in the Opening Pictures

The pictures in the raw chapter show people engaged in the same profession. In the context of the chapter, they most likely belong to the postal service:
...
## Difficulties Faced by Postal Workers

Postal workers, especially in remote areas, may face:
...
- heavy mailbags;
- lack of transport;
- emotional difficulty while delivering bad news;
- pressure to deliver on time.

## How Their Profession Affects People

Postal workers connect people by carrying:
...
For many remote communities, they are not just workers. They are trusted links with the outside world.
...
The travellers' bodies sent warning signals in the desert heat. They passed hamlets but found no one outside defying the sun. Even camels were slumped in shade. The area depended on BSNL because it was devoid of other network services.

---

# Unit 7B: Carrier of Words
...
Khetaram is the sole postman of Somarad Branch Post Office. For more than fifteen years, he has served remote hamlets in the Thar desert of Rajasthan. His shoulder has slumped from years of carrying a mailbag.

He works in harsh conditions:
...
- long walking distances;
- remote settlements;
- lack of roads and phone lines.

Yet he remains a trusted figure for villagers.
...
Khetaram does more than deliver letters. He:

- carries money orders;
- connects families separated by distance;
- reads letters for villagers;
- writes replies for them;
- delivers birth and wedding news;
- handles death news respectfully;
- helps maintain trust in the postal system.

## Gramin Dak Sewaks in India
...
## Money Orders and Social Trust

In arid regions, survival often depends on money sent by relatives. Money orders are therefore not just financial transactions; they are lifelines.

Villagers trust the post office because:

- it reaches remote places;
- it handles small sums reliably;
- it connects migrant workers with families;
- it keeps formal financial records;
- it is represented by familiar local workers like Khetaram.

---

# Unit 7C: Prose Comprehension
...
Khetaram took up the job because farming in the arid region could not support his family. In a good year he got only one crop of bajra, which was not enough to feed five people. The GDS job gave him assured income and dignity.

## How Might Khetaram Feel About the Task?

He may feel:

- tired because of heat and distance;
- responsible because people depend on him;
- proud because he serves remote communities;
- grateful because the job supports his family;
- emotionally burdened when carrying death news.
...
Jaggery is a simple sweet offered as a token of joy. In villages where resources are limited, even a small piece of jaggery becomes a warm gesture of celebration and gratitude.

## How Would Phone Lines Help Khetaram?

Phone lines would allow faster communication. Khetaram might become a Gramin Sanchar Sewak, carrying a cell phone along with post from home to home. This would combine postal service with telecommunication support.

---

# Unit 7D: Critical Reflection and Long Answers

## Extract 1: Famine and Livelihood

### Context

Khetaram explains why the GDS job is necessary for survival in an arid region.
...
Khetaram explains the custom of handling letters that carry death news.
...
### 1. Why does the Postmaster-General call the role of GDS invaluable?

The role is invaluable because GDS workers reach interior regions that may be inaccessible by regular transport. They connect remote people with families, financial services, news, and official systems. In places like deserts, islands, frozen areas, and riverine regions, they are often the only practical link between the state and citizens.

### 2. How was India Post different from the British postal system?

The British postal system mainly carried official mail between administrative centres. After independence, India Post aimed to include the entire population within the postal network. Its purpose became public service and national connection, not only administration.

### 3. Give two examples showing people trusted Gramin Dak Sewaks.

First, villagers allowed Khetaram to stand at their threshold, read letters aloud, and write replies. This shows personal trust. Second, people depended on the post office for money orders from relatives, showing financial trust in the postal system.

### 4. Why was Khetaram grateful to continue as GDS after 60?

He was grateful because the job gave him income, purpose, and social respect. In a region where farming was unreliable, the job helped him support his family even in old age.

### 5. Why does the author pay tribute to people like Khetaram?

The author pays tribute because people like Khetaram serve society silently under extreme difficulty. They connect isolated communities, carry emotional news, and sustain trust in public systems. Their work is physically hard and socially meaningful.

---

# Unit 7E: Vocabulary and Grammar
...
## Passive Voice Advice Paragraph

Original advice:

- You will need stamina.
- Practise reading clearly.
- Write words neatly.
- Wear full-sleeved shirts and trousers.

Completed passive paragraph:
...
# Unit 7F: Speaking, Writing, and Learning Beyond the Text

## Listening Task: Letter Writing Carnival
...
## Model Condolence Message

Task: Write a condolence message to your aunt after the passing away of her father.
...
We are deeply saddened to hear about the passing away of your father. Please
accept our heartfelt condolences. We pray that God gives peace to the departed
soul and strength to you and the family in this difficult time. We are with you
in your grief.
...
## Condolence Writing Checklist

- Keep the tone respectful.
- Mention sadness at the loss.
- Offer sympathy.
- Pray or wish strength for the family.
- Keep it brief.
- Avoid casual language.

## Daakroom Carnival

The raw chapter mentions **Daakroom**, a carnival conceptualised by the Ministry of Culture to revive letter writing.

Its purpose:

- reintroduce children to letter writing;
- provide digital detox;
- organise competitions and workshops;
- connect audiences with postal heritage;
- make writing creative and engaging.
...
Before fast digital communication, telegrams were used for urgent short messages such as:
...
Because telegram pricing depended on the number of words, messages had to be brief and precise.
...
The poem argues that words often fail to satisfy the heart. Many words may disappear like birds or prove as worthless as weeds. But a few sincere words can bring deep joy and comfort. The poet values truth, warmth, and emotional honesty over a large number of empty words.
...
The poem mainly uses an **ABAB** rhyme pattern in each stanza.
...
The repetition keeps the reader focused on the central question: what makes words meaningful?

## Emotions in Stanzas 4, 5, and 6

Best option:

**(iii) Stanza 4 - admiration, Stanza 5 - frustration, Stanza 6 - disillusionment**

Why:

- Stanza 4 admires a few dear words that cheer a lonely home.
- Stanza 5 shows frustration that words often fail when tested.
- Stanza 6 shows disillusionment with showy words that produce no fruit.
...
The poet exaggerates to show how greatly the world would celebrate if words truly satisfied emotional needs.
...
# Unit 7H: Poem Critical Reflection

## Extract 1: Heart as Pilgrim
...
The poet suggests that many words disappear without leaving comfort or meaning, just as air cannot be held. Empty words may be spoken, but they do not remain in the heart.

### 2. Why are meaningful words more precious than many words?

Meaningful words are sincere and emotionally true. Even a few such words can comfort a lonely person, express love, or bring courage. Many empty words may sound impressive but fail to touch the heart.

### 3. Does the poem present contrasting ideas about words?

Yes. The poem contrasts empty words with sincere words. Empty words are compared to birds that depart, weeds, and plants without fruit. Sincere words are shown as dear, cheering, and capable of deep joy.

### 4. How does loneliness hover over the poem?

The poem refers to the heart as a pilgrim and mentions a lonely home needing cheer. These images suggest emotional isolation. The poem asks whether words can truly comfort a lonely heart.

### 5. How does the poet convey the superficial nature of words?

The poet compares empty words to gaudy plants that blossom but bear no fruit. This means they may look attractive but produce no real benefit. To address this, people should speak fewer words, but make them truthful, kind, and heartfelt.

---

# Unit 7I: Vocabulary in Context
...
# Unit 7J: Listening, Speaking, and Essay Writing

## Listening: Conversation About Declamation
...
The raw chapter gives quotations by Gautama Buddha, Swami Vivekananda, Mahatma Gandhi, Kalpana Chawla, Walt Whitman, Emily Dickinson, Homer, and Martin Luther King Jr.
...
- I decided on... due to...
- I picked... as...
- I settled for... because...

## Example Response

I chose Mahatma Gandhi's quotation, "It is better in prayer to have a heart without words than words without a heart," because it connects directly with the poem. It means sincerity is more important than language. A silent but honest feeling can be better than a beautiful speech without emotion.
...
Mahatma Gandhi said, "It is better in prayer to have a heart without words than words without a heart." This quotation appeals to me because it reminds us that sincerity matters more than impressive language. The purpose of this essay is to show why words need feeling behind them.

First, words without emotion can sound empty. A person may apologise beautifully but not mean it. Such an apology does not heal the hurt. However, even a simple "I am sorry" can bring peace if it is spoken sincerely.

Second, silence can sometimes communicate more than speech. Sitting beside a grieving person, helping a friend, or listening patiently can express care without many words. In such moments, the heart speaks through presence.

Some people may argue that words are always necessary because thoughts must be expressed. This is partly true. However, words become meaningful only when they carry honesty. Without sincerity, they may impress the ear but fail to touch the heart.

Therefore, Gandhi's quotation teaches us to value truth in communication. Words should not be used merely to fill silence. They should carry kindness, respect, and feeling.

---

# Unit 7K: Non-Verbal Communication and Supplementary Poem

## Non-Verbal Game

The raw chapter suggests a game using expressions and gestures.
...
The chapter mentions Charles-Michel de l'Epee, recognised as the Father of Sign Language and Deaf Education.

This connects with the chapter's larger idea: words are important, but communication is larger than spoken language.

## Supplementary Poem: Weigh Your Words

### Short Appreciation

The poem "Weigh Your Words" advises people to think carefully before speaking. Idle words and careless promises can hurt others. The poem teaches that fewer thoughtful words are better than many careless ones.
...
# Unit 7N: Practice Questions

## Prose: Short Answer

1. Who is Khetaram?
2. What is a Gramin Dak Sewak?
3. Why is Khetaram's work physically difficult?
4. How does the desert geography affect postal delivery?
5. Why do villagers trust Khetaram?
6. What is the importance of money orders?
7. Why does Khetaram dread some letters?
8. What does the torn corner of an envelope signify?
9. How might phone lines change Khetaram's work?
10. Why does the author salute people like Khetaram?

## Prose: Long Answer

1. Explain how Khetaram is a carrier of words and emotions.
2. Discuss the social importance of Gramin Dak Sewaks.
3. Compare the British postal system with India Post after independence.
4. How does the text show trust between villagers and postal workers?
5. Describe the hardships of desert postal service.

## Grammar and Vocabulary

1. Use "new lease of life" in a sentence.
2. Identify alliteration in "scorching summer winds and swirling sandstorms".
3. Write five sentences in present perfect tense.
4. Convert two active sentences into passive voice.
5. Create a word map for "pilgrim".

## Poem: Short Answer

1. Why are words compared to summer birds?
2. Why is the heart called a pilgrim?
3. What does the comparison with weeds suggest?
4. Why are a few sincere words better than many words?
5. What is the rhyme scheme of the poem?
6. Identify one example of hyperbole.
7. What is the poem's main message?

## Writing Practice

1. Write a condolence message.
2. Write an essay on one quotation about words.
3. Prepare a debate as postcard, inland letter, envelope, or money order form.
4. Write a paragraph on why letter writing still matters.

---

## Final Chapter Summary

- "Carrier of Words" tells the story of Khetaram, a Gramin Dak Sewak in Rajasthan.
- Khetaram delivers mail in harsh desert conditions.
- He is a trusted link between remote villagers and their families.
- He carries letters, money orders, birth news, wedding news, and death news.
- The prose shows the importance of India Post and rural postal workers.
- The grammar section teaches present perfect tense and passive voice.
- The writing task teaches condolence messages.
- The poem "Words" reflects on the limits of empty language.
- Charles Swain values a few sincere words more than many hollow ones.
- The poem uses simile, metaphor, hyperbole, repetition, and rhyme.
- The chapter connects physical communication with emotional communication.
...
1. Memorise Khetaram's role, place, and challenges.
2. Link every answer to trust, remoteness, service, and communication.
3. Remember examples: mailbag, desert heat, money orders, threshold, death letters.

For grammar:

1. Present perfect uses has/have + past participle.
2. Passive voice makes the receiver of the action the subject.
3. Practise by changing practical advice into passive form.

For the poem:

1. Learn the central contrast: empty words versus sincere words.
2. Remember the key images: birds, pilgrim, weeds, feast, fruitless plants.
3. Use terms such as simile, metaphor, hyperbole, repetition, and ABAB rhyme.

For writing:

1. Condolence messages must be brief, respectful, and sincere.
2. Essays on quotations need explanation, examples, counterargument, and conclusion.
3. Word maps help build vocabulary depth.
