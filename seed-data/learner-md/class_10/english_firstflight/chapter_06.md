...
This chapter has two very different pieces.

The prose piece, "Mijbil the Otter", is a personal narrative. Gavin Maxwell tells how he acquired an otter in Iraq, formed a deep bond with him, struggled to transport him to England, and observed his intelligence in everyday life.

The poem, "Fog", is short and image-rich. Carl Sandburg compares fog to a quiet animal that arrives silently, observes the city and harbour, and then leaves.

Together, the prose and poem train learners to notice movement, behaviour, silence, and atmosphere.

---

# Unit 6A: Before Reading

## Why the Chapter Begins with Pet Responsibility

Before the narrative begins, learners are asked to think about pets. This is important because the chapter is not just a funny story about an unusual animal. It also raises questions about care, habitat, transport, and responsibility.

Owning an animal is not only about affection. It requires:

- food suited to the animal;
- shelter and space;
- medical care;
- exercise;
- hygiene;
...
- legal permission, especially for protected or wild animals;
- family agreement;
...
# Unit 6B: Mijbil the Otter - Part I
...
Gavin Maxwell lives in Camusfearna in the West Highlands of Scotland. His home is surrounded by water nearby, making it suitable for an animal that enjoys water. After his dog Jonnie dies, Maxwell feels too sad to keep another dog. Life without a pet feels lonely, so he begins thinking about an otter instead.
...
Maxwell travels to Southern Iraq early in 1956. He and his friend go to Basra to collect and answer mail from Europe at the Consulate-General. His friend's mail arrives, but Maxwell's does not.

He tries different ways to contact England:

- he sends a cable;
- he waits several days;
- he attempts to telephone;
- telephone booking and technical failures delay him;
- his friend leaves before him.

After five more days, Maxwell's mail finally arrives.

## Arrival of the Otter

When Maxwell takes his mail to the bedroom, he finds two Arabs sitting there. Beside them is a sack that moves from time to time. They hand him a note from his friend. The note tells him that the otter has arrived.

This is the beginning of Maxwell's life with Mijbil.
...
The story is told by Maxwell himself, so we experience events through:

- what he sees;
- what he feels;
- what he fears;
- what surprises him;
- what he later understands.

This makes the narrative personal and intimate.

---

# Unit 6C: Mijbil the Otter - Part II

## Mijbil's First Appearance

When Mijbil emerges from the sack, Maxwell sees a creature covered in mud. The mud forms pointed scale-like patterns on his body, making him look strange and almost mythical.

Under the mud, Mijbil has soft brown fur. Maxwell does not see his true appearance properly until later, after the mud is fully removed.
...
Maxwell takes Mijbil to the bathroom on a lead. Mijbil becomes wildly happy in the bathtub.

His actions show that otters:

- love water;
- roll, splash, and swim actively;
- enjoy keeping water in motion;
- treat still water as something to be disturbed;
- may overturn bowls or sit inside them.

## Tap Incident

Two days later, Mijbil escapes from the bedroom and goes to the bathroom. Maxwell finds him at the bathtub, trying to work the taps with his paws.

This moment is important because it shows:

- curiosity;
- intelligence;
- trial-and-error learning;
- memory of where water comes from;
- comic determination.

Mijbil sometimes turns the tap the wrong way and becomes irritated when water does not come. That detail makes him seem almost human.
...
# Unit 6D: Mijbil the Otter - Part III
...
Maxwell puts Mijbil into the box before leaving for a quick meal, hoping the otter will get used to it. When he returns, the scene is shocking.

Mijbil has:

- injured himself;
- torn the box lining;
- left blood at the holes and edges;
- become exhausted and distressed.

Maxwell removes the dangerous lining, but there are only a few minutes before the flight. He has no practical choice but to put Mijbil back in the box and rush to the airport.
...
The air hostess listens to Maxwell and understands the situation. She suggests that he may keep the animal on his knee instead of forcing it to remain in the box.

Maxwell calls her "the very queen of her kind" because she is:
...
- sympathetic;
- willing to help;
- humane toward the animal.

## The Airplane Episode

When the box is opened, Mijbil escapes quickly and runs through the aircraft. Passengers panic because they do not know what he is. One woman thinks he is a rat. Maxwell tries to catch him, and the scene becomes chaotic and comic.

Eventually, Mijbil returns to Maxwell, makes a sound of recognition, climbs onto him, and rubs his face and neck affectionately.
...
This section moves through tension and relief:

1. Maxwell worries about transport.
2. The box incident shocks him.
3. The airport rush increases pressure.
4. The air hostess reduces the problem.
5. Mijbil's escape creates comic panic.
6. Mijbil's affectionate return restores calm.

This pattern keeps the narrative lively.

---

# Unit 6E: Mijbil the Otter - Part IV

## Mijbil in London

After reaching London, Maxwell and Mijbil stay there for nearly a month. Mijbil has toys and invents his own games. The London setting also shows how unusual an otter appears to city people.

## Mijbil's Suitcase Game

Mijbil uses a damaged suitcase with a sloping lid. He places a ping-pong ball on the higher end so it rolls down. Then he runs to the other side, waits, jumps out, catches the ball, and repeats the game.
...
- ability to create play from ordinary objects.

## Compulsive Habits

Compulsive habits are repeated actions that a person or animal feels driven to perform.
...
Opposite Maxwell's flat is a primary school with a low wall along the front. On the way home, Mijbil insists on climbing onto the wall and running along it.

This distracts:

- pupils;
- teachers;
- anyone watching from inside.

The episode is humorous because a normal walk becomes a public performance.
...
# Unit 6F: Thinking About the Text
...
From this text, we learn that otters:

- are strongly connected with water;
- enjoy splashing and swimming;
- are intelligent and playful;
- can form attachments to humans;
- need space and stimulation;
- may be difficult to transport;
- belong to the mustelline group;
- may not be recognized easily by people unfamiliar with them;
- are not ordinary domestic pets.

## Why Mijbil's Species Is Known as Maxwell's Otter

Mijbil belonged to a race of otter previously unknown to science. Because Gavin Maxwell owned, observed, and brought attention to this otter, zoologists associated the creature with his name. The scientific naming honours that connection.
...
Maxwell's narration works because he combines:
...
# Unit 6G: Language Work

## 1. Describing Repeated Action in the Past

We use `would` and `used to` to describe repeated actions in the past.
...
- Mij would follow Maxwell without a lead.
- Mij would play with toys for hours.
- On the way home, Mij would tug Maxwell toward the wall.
...
- Mij used to play with marbles.
- Maxwell used to exercise him on a lead.
- People used to keep fewer unusual pets under modern legal restrictions.
...
If the verb describes an action you can watch happening, `would` is usually possible. If the verb describes a state such as `be`, `have`, `believe`, `know`, or `own`, prefer `used to`.

---

## 2. Noun Modifiers

A modifier gives more information about a noun.
...
- proper nouns used before nouns.
...
## 3. Quantity Phrases for Uncountable Nouns

Some nouns are difficult to count directly. We use quantity phrases with them.
...
# Unit 6H: Speaking, Writing, and Discussion

## Dumb Charades Activity

The activity asks students to express a feeling or thought silently through gestures.
...
## Why This Activity Fits the Chapter

Maxwell cannot ask Mijbil what he feels. He observes actions and guesses feelings. Dumb charades trains the same skill: reading meaning through movement and expression.

## Writing Task: Describe a Person or Animal
...
My neighbour's dog Bruno is not impressive because of size or breed, but because of the way he understands moods. When I return from school tired, he does not bark loudly. He walks beside me, presses his head against my knee, and waits until I speak to him.

This kind of opening works because it uses behaviour to reveal character.

## Discussion: Changes in Pet Rules

The events in the story happened many decades ago. Today, animal laws and public awareness are stricter.

Topics for discussion:

- which animals can legally be kept as pets;
- wildlife protection laws;
- import and export rules for animals;
- vaccination and quarantine rules;
- airline transport rules;
- ethical concerns about wild animals in homes;
- difference between rescue care and entertainment.
...
The poem imagines fog as a cat-like presence. It arrives quietly, settles over the harbour and city, watches silently for a while, and then moves away.

The poem does not explain fog scientifically. It makes the reader see fog as a living, graceful, silent creature.

## What Is the Fog Compared To?

The fog is compared to a cat.

The poet suggests this through:
...
A metaphor directly transfers qualities of one thing to another.

Here, fog is not said to be "like" a cat using a simile. Instead, the fog is described as if it has cat-like feet and posture. That makes the comparison stronger and more compressed.
...
"Fog" does not follow a fixed rhyme scheme. It also does not depend on a regular beat. This style is called free verse.

Free verse suits the poem because fog itself does not move in a strict pattern. It drifts, settles, and moves on naturally.

## Rhyme Scheme

The poem has no clear rhyme scheme. That means there is no repeated pattern such as `abab` or `aabb`.
...
Then compare it with an animal.

## Sample Storm Poem

The storm crouched behind the hill,  
then sprang across the fields.  
Its claws shook the windows,  
its breath bent the trees,  
and when it had gone,  
the road lay shining and still.
...
# Unit 6L: Practice Questions

## Short Answer Questions

1. Why did Maxwell decide not to keep another dog?
2. Why was Camusfearna suitable for an otter?
3. Why did Maxwell go to Basra?
4. How did Mijbil arrive?
5. How did Mijbil behave during the first twenty-four hours?
6. What happened when Mijbil was taken to the bathroom?
7. Why was Mijbil named Maxwell's otter?
8. What did Mijbil do to the transport box?
9. Why did Maxwell admire the air hostess?
10. What game did Mijbil invent in London?
11. What compulsive habit did Mijbil develop?
12. What guesses did Londoners make about Mijbil?
13. What group of animals do otters belong to?
14. How does Sandburg compare fog to a cat?
15. Why is "Fog" called free verse?

## Long Answer Questions

1. Describe how Maxwell's relationship with Mijbil develops from first meeting to affection.
2. How does the chapter show that Mijbil is intelligent and playful?
3. Explain the humour in the airplane episode.
4. What does the chapter teach about responsible pet ownership?
5. How does Maxwell use careful observation to make Mijbil seem alive to the reader?
6. Discuss the ethical questions raised by keeping unusual or wild animals as pets.
7. Explain the central metaphor of "Fog".
8. Compare the way movement is described in "Mijbil the Otter" and "Fog".

## Grammar Practice

1. Write five sentences using `would` for repeated past actions.
2. Write five sentences using `used to` for past states or situations.
3. Identify the main noun and modifiers in these phrases: `London streets`, `otter fixation`, `soft velvet fur`, `school wall ritual`, `animal transport rule`.
4. Use these quantity phrases in sentences: `a bit of`, `a piece of`, `a cloud of`, `a lump of`, `a gust of`.

## Writing Practice

1. Write a description of an animal you know well.
2. Write a diary entry from Maxwell's point of view after the airplane incident.
3. Write a paragraph on why wild animals should or should not be kept as pets.
4. Write a free verse poem comparing weather to an animal.

---

## Final Chapter Summary

- Gavin Maxwell feels lonely after the death of his dog and considers keeping an otter.
- He receives Mijbil in Basra through a friend's arrangement.
- Mijbil is first aloof, then gradually becomes attached to Maxwell.
- Water, play, curiosity, and intelligence define Mijbil's personality.
- The journey to England is stressful because Mijbil is injured in the transport box.
- The air hostess shows kindness, and the airplane scene becomes both comic and emotional.
- In London, Mijbil invents games and attracts strange guesses from people.
- The language section teaches `would`, `used to`, noun modifiers, and quantity phrases.
- "Fog" compares fog to a cat and uses free verse to create a quiet, visual effect.

---

## Study Strategy for Learners

1. Make a timeline of Maxwell's journey from Iraq to London.
2. Create a two-column chart: Mijbil's action and what it shows about him.
3. Memorise the difference between `would` and `used to`.
4. Practise identifying the main noun at the end of noun phrases.
5. For "Fog", remember four keywords: cat, silence, metaphor, free verse.
6. While answering long questions, use specific incidents: bathroom, taps, box, airplane, suitcase game, school wall, London guesses.
7. For ethics questions, balance affection with animal welfare and habitat needs.
