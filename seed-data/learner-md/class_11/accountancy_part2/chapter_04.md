...
This chapter explains why computers became important in accounting, what a computer system is made of, how accounting information moves through a computerised system, and how accounting reports support management decisions.

Do not study this chapter as a computer science chapter only. In Accountancy, the main concern is this:

> How does a business use computer systems to record transactions, process accounting data, and produce useful reports for decision-making?
...
1. Define a computer system and identify its major elements.
2. Explain the capabilities and limitations of computers.
3. Describe the need for computers in accounting.
4. Explain how transactions are processed in a computerised accounting environment.
5. Distinguish between batch processing and real-time processing.
6. Explain the features of a computerised accounting system.
7. Define MIS and AIS and show how accounting information supports management.
8. Describe the major types of accounting reports.
9. Explain how accounting reports are designed from accounting data.
10. Understand how AIS exchanges information with other functional information systems.
...
Accounting information
        |
        v
Reports for users and management decisions
```

In manual accounting, many of these steps are performed through books, ledgers, calculations, and manual checking. In computerised accounting, the same accounting logic remains, but computers perform storage, processing, retrieval, and reporting much faster.

---

## 1. Meaning of a Computer System

A computer is an electronic device that performs operations according to a set of instructions called a program.
...
Hardware means the physical and visible parts of a computer system.
...
Procedures are ordered steps followed to achieve desired results.

In accounting, procedures are essential because financial information must be accurate, authorised, and traceable.
...
Data means raw facts. In accounting, data may include:
...
Data becomes information only after it is processed and arranged for a purpose.
...
Connectivity means the way a computer system is connected to other systems.

Accounting relevance:

- Branches can send transaction data to head office.
- Sales department can share order information with accounts.
- Inventory system can update stock after billing.
- Bank data can be imported for reconciliation.
- Managers can access reports from different locations.

Connectivity turns isolated accounting records into a broader information system.

---

## 3. Capabilities of Computer Systems

Computers are useful in accounting because they perform repeated data processing tasks quickly and consistently.

### 3.1 Speed

Computers can process a large number of transactions in very little time.

Accounting example:

A manual accountant may take hours to total ledger balances and prepare a trial balance. Accounting software can generate a trial balance almost instantly after vouchers are entered.

### 3.2 Accuracy

Computers perform calculations accurately if the program and input data are correct.

Important warning:

> Computers reduce arithmetic errors, but they do not eliminate human errors in data entry or wrong account selection.

If sales are entered as purchases, the computer will process the wrong entry accurately. Therefore, accuracy depends on both machine processing and human control.

### 3.3 Reliability

Computers are reliable for repetitive work because they do not get tired or bored.

Accounting example:

Generating hundreds of customer statements is repetitive. A computer can perform this task consistently, provided the data and software are correct.

### 3.4 Versatility

Computers can perform many different tasks.

In an accounting office, the same system may be used for:
...
Computers can store large volumes of data in a small physical space.

In manual accounting, ledgers, vouchers, and registers require physical storage. In computerised accounting, much of the data can be stored electronically and retrieved quickly.

---

## 4. Limitations of Computer Systems
...
> A computer can process accounting data, but it cannot replace accounting judgement.

---

## 5. Components of a Computer

A computer performs three basic functions:
...
The input unit allows data to enter the computer.
...
The CPU is the main processing part of the computer. It controls and processes data.
...
When a sales voucher is entered, the CPU processes the amount, tax, account codes, ledger updates, and report effects according to the software instructions.

### 5.3 Output Unit

The output unit presents processed information in a usable form.
...
## 6. Need for Computers in Accounting

Computers became important in accounting because business operations became larger, faster, and more complex.

Manual accounting is suitable when transactions are few and simple. But modern organisations often have:
...
- Need for quick management reports
- Need for data sharing between departments
...
## 7. Evolution of Computerised Accounting
...
## 8. Information and Decisions

Information is a key organisational resource. Managers need information to allocate resources, control activities, and make decisions.

Accounting data becomes useful when it is processed into decision-ready information.
...
A Transaction Processing System, or TPS, records, processes, validates, stores, and reports transactions.
...
An ATM example helps understand transaction processing:

1. Customer enters card and PIN.
2. System validates identity.
3. Customer enters withdrawal amount.
4. System checks balance and limits.
5. Cash is dispensed if transaction is valid.
6. Transaction is stored in the banking database.
7. Balance and transaction information can be reported later.

Accounting software follows a similar logic: accept data, check it, process it, store it, and report it.

---

## 10. Batch Processing and Real-Time Processing
...
- Real-time processing = enter now, update now.

---

## 11. Features of a Computerised Accounting System
...
> Computerised accounting does not remove accounting principles. It changes the method of recording, processing, and reporting.

---

## 12. Management Information System

Management Information System, or MIS, is a system that provides information needed to manage an organisation effectively.
...
Accounting Information System, or AIS, identifies, collects, processes, and communicates economic information about an entity.

AIS is a part of the wider MIS.
...
AIS does not work in isolation. It receives information from other departments and provides information to them.
...
## 14. Designing Accounting Reports

Data becomes useful only when it is arranged into a report that supports a decision.
...
If the objective is to collect money from customers, the report should not merely list all sales. It should show customer name, invoice amount, due date, days overdue, and contact status.

---

## 15. Types of Accounting Reports

### 15.1 Summary Reports

Summary reports present condensed information.
...
Use: They help users see the overall position or performance.

### 15.2 Demand Reports

Demand reports are prepared when management asks for specific information.

Examples:

- Bad debts report for a specific product
- Stock valuation report for a selected date
- Supplier purchases for a selected month

Use: They support specific decisions.

### 15.3 Customer and Supplier Reports

These reports focus on parties with whom the business deals.
...
Use: They help manage relationships, collections, purchases, and payments.

### 15.4 Exception Reports

Exception reports show cases that need attention because they differ from normal expectations.
...
Use: They help managers focus on problems instead of reading all routine data.

### 15.5 Responsibility Reports

Responsibility reports are linked to the duties of a manager or department.

Examples:

- Cash position report for finance department
- Production cost report for production manager
- Sales target report for sales manager

Use: They support accountability and performance control.

---

## 16. Data Interface Between Information Systems

An information system becomes stronger when departments share useful data.
...
### Frame 1: Explain the elements of a computer system

Use this order:

1. Define computer system.
2. Name the six elements.
3. Explain each element briefly.
4. Add an accounting example.

Model opening:

> A computer system is a complete arrangement of hardware, software, people, procedures, data, and connectivity that processes data according to instructions. In accounting, these elements work together to record transactions and produce reports.

### Frame 2: Explain the need for computers in accounting

Use this order:

1. Mention growth in business transactions.
2. Explain need for speed, accuracy, storage, and timely reports.
3. Connect to management decision-making.
4. Add examples such as trial balance, stock report, ageing report.

### Frame 3: Explain transaction processing

Use this order:

1. Define TPS.
2. List the steps: data entry, validation, processing, storage, information, reporting.
3. Give a business or ATM example.
4. Explain why validation is important.

### Frame 4: Explain AIS as part of MIS

Use this order:

1. Define MIS.
2. Define AIS.
3. State that AIS is a subsystem of MIS.
4. Explain information exchange with sales, manufacturing, HR, and purchase.
5. Give examples of reports.
...
2. Name the six elements of a computer system.
3. What is application software?
4. What is meant by data in a computer system?
5. Give two examples of input devices used in accounting.
...
10. What is Accounting Information System?

### Long Answer Questions

1. Explain the elements of a computer system with examples from accounting.
2. Describe the capabilities and limitations of computer systems.
3. Explain the need for computers in accounting.
4. Describe the steps involved in transaction processing.
5. Explain the features of a computerised accounting system.
6. What is MIS? Explain the role of AIS as a subsystem of MIS.
7. Explain the different types of accounting reports.
8. Describe the steps involved in designing accounting reports.
9. Explain how AIS exchanges data with HR, marketing, and manufacturing information systems.

---

## 22. Learner Checklist

Before leaving this chapter, make sure you can:

- Define hardware, software, people, procedures, data, and connectivity.
- Explain why computers are useful in accounting.
- List the capabilities and limitations of computers.
- Draw the input-processing-output idea.
- Explain the steps of TPS.
- Distinguish batch processing from real-time processing.
- Define MIS and AIS.
- Explain why AIS is a part of MIS.
- Name different accounting reports and their uses.
- Write an answer on report design using relevance, timeliness, accuracy, completeness, and summarisation.

---

## Final Takeaway

Computers make accounting faster, more reliable, and more useful for decision-making, but they do not replace accounting logic or human judgement. A good computerised accounting system depends on correct data, suitable software, trained people, proper procedures, and meaningful reports.
