...
1. Explain the meaning of financial statement analysis.
2. State the significance of analysis.
3. Identify objectives of analysis.
4. Describe major tools of analysis.
5. Prepare comparative balance sheet.
6. Prepare comparative statement of profit and loss.
7. Prepare common size balance sheet.
8. Prepare common size statement of profit and loss.
9. Calculate trend percentages.
10. State limitations of financial analysis.
11. Interpret percentage changes in a learner-friendly way.
...
Financial statement analysis means careful study of financial statements to understand profitability, efficiency, liquidity, solvency, and overall financial health.

Analysis and interpretation are linked:

1. Analysis simplifies figures.
2. Interpretation explains what the simplified figures mean.

Without interpretation, percentages and ratios are just numbers.

# Unit 4B: Significance of Analysis
...
3. Assess short-term liquidity.
4. Assess long-term solvency.
5. Compare performance over time.
6. Compare with other firms.
7. Identify strengths and weaknesses.
8. Support forecasting and planning.
9. Support investment and lending decisions.
...
Comparative statements show financial figures for two or more periods side by side and calculate change.

## Columns Usually Used

1. Previous year amount.
2. Current year amount.
3. Absolute increase or decrease.
...
Percentage change = Absolute change x 100 / Previous year amount

## Comparative Balance Sheet

A comparative balance sheet compares assets, equity, and liabilities between two dates.

It helps identify:

1. Growth in assets.
2. Increase or decrease in borrowings.
3. Changes in working capital.
4. Changes in shareholders' funds.
5. Increase or decrease in liquidity.

## Comparative Statement of Profit and Loss

This compares revenue and expenses between two periods.

It helps identify:

1. Sales growth.
2. Expense control.
3. Change in gross or operating performance.
4. Profit growth or decline.
5. Tax impact.
...
Common size percentage = Item amount x 100 / Common base

## Why It Is Useful

Common size statements make comparison easier even when firms are of different sizes.

Example: A small company and a large company can both be compared by gross profit percentage, expense percentage, and asset composition.
...
Trend percentage studies movement over several years by selecting one base year.

## Formula

Trend percentage = Current year value x 100 / Base year value
...
## Rules for Good Trend Analysis

1. Use a normal base year.
2. Use consistent accounting policies.
3. Compare related items.
4. Interpret trend with business context.
5. Beware of inflation and one-time events.
...
A company's revenue increased from Rs. 5,00,000 to Rs. 6,50,000. Expenses increased from Rs. 4,00,000 to Rs. 5,46,000.

## Revenue Change

Increase = Rs. 1,50,000.

Percentage increase = 1,50,000 x 100 / 5,00,000 = 30 per cent.

## Expense Change

Increase = Rs. 1,46,000.

Percentage increase = 1,46,000 x 100 / 4,00,000 = 36.5 per cent.

## Interpretation

Revenue increased, but expenses increased faster. Profit may still increase in absolute amount, but profit margin is likely under pressure.
...
1. Sales increased from Rs. 8,00,000 to Rs. 10,00,000. Calculate absolute and percentage change.
2. Total assets are Rs. 12,00,000 and inventory is Rs. 3,00,000. Find inventory common size percentage.
3. Base year profit is Rs. 2,00,000 and current year profit is Rs. 2,80,000. Find trend percentage.
4. State four objectives of financial statement analysis.
5. Give two examples where an increase in amount may be unfavourable.

## Final Revision

Financial analysis is not just calculation. A good learner must calculate correctly and then ask: What does this movement mean? Which user cares about it? Is the change favourable, unfavourable, or incomplete without more context?
